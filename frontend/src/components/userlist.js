                    ...
                    {props.state.users.map((e, i) => {
                            return (
                                <div className="row justify-content-between p-3" key={i} >
                                    <span className='col-7' onClick={props.handleUserClick} id={e.id} style={props.state.currentUser.id === e.id ?{backgroundColor: "#dc3545", borderRadius: "3px"}: {backgroundColor: "transparent"}} >{e.username}</span>
