...
const UserWelcome = (props) => {
    ...
    return (
        <div>
            ...
            {
                props.currentUser.length !== 0 && props.location === "/user/post" ? <><div className="jumbotron" style={{ background: "linear-gradient(0deg,rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url(http://thesmartlocal.com/images/easyblog_articles/6617/b2ap3_large_image12.jpg)", backgroundSize: "50% 100%" }}>
                    <h1 className="display-4" style={{ color: "white" }}>Welcome {props.currentUser.username}</h1>
                    <h4 style={{ color: 'white' }}>Your User ID
            Is: {props.currentUser.id}</h4>
                    <div className="row">
